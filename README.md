<div align="center">
  ...
  <p>
    <a href="https://github.com/flyanx/FloatNote/releases"><b>下载安装包</b></a> ·
    <a href="#功能特性">功能一览</a> ·
    <a href="#安装">快速安装</a> ·
    <a href="#更新日志">更新日志</a>
  </p>
...
- **多格式导入** — Markdown（.md）、纯文本（.txt）、HTML、Word（.docx）
- **多格式导出** — Markdown、TXT、HTML、Word、PDF
...
| 系统托盘 | 关闭按钮收纳到托盘，不占用任务栏；右键可快速新建笔记/待办 |
| 中英双语 | 一键切换界面语言 |
